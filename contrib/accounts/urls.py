...
from .views import SignInView, SignOutView, UserProfileViews, user_profile, sign_up, signout_user, SignUpViews
...
urlpatterns = [
    ...
    path('profile/', UserProfileViews.as_view(), name='current_user_profile'),
    # path('profile/<int:id>/', user_profile, name='user_profile'),
    path('profile/<int:id>/', UserProfileViews.as_view(), name='user_profile'),
